...
## 更新摘要
**所做更改**
- 移除了所有与Shopify应用前端相关的组件、页面和配置
- 更新了项目结构图，移除了shopify-app相关节点
- 更新了页面路由配置，移除了Shopify相关的路由
- 更新了组件分析，移除了Shopify特有的组件和功能
- 更新了API客户端配置，移除了Shopify相关的API接口
- 更新了故障排查指南，移除了Shopify相关的诊断步骤
...
**重要更新**：根据最新的代码变更，实验性的 Shopify 应用前端（shopify-app/ 目录）已被完全移除，包括 React/TypeScript 代码库、Docker 配置和 Prisma 数据库架构。本文档现已更新以反映这一重大变更。
...
**重要更新**：随着 Shopify 应用前端的移除，系统现在专注于核心合规管理功能，简化了架构复杂度并提高了维护效率。
